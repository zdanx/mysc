        ...
        for _, gui in ipairs(coreGui:GetChildren()) do
            ...
            if homeNode and homeNode:FindFirstChild("Interactions") then
                ...
                if discordFrame and clientFrame and friendsFrame and serverFrame and userFrame then
                    ...
                    -- 1. Memodifikasi frame Discord beserta teks Subtitle-nya
                    discordFrame.Position = UDim2.new(0, 448, 0, 129)
                    discordFrame.Size = UDim2.new(0, 287, 0, 90)
                    ...
                    -- 2. Memodifikasi frame Client (Xeno) beserta teks Subtitle-nya
                    clientFrame.Position = UDim2.new(0, 511, 0, 450)
                    clientFrame.Size = UDim2.new(0, 328, 0, 90)
                    local clientSubtitle = clientFrame:FindFirstChild("Subtitle")
                    if clientSubtitle then
                        -- Teks asli: "You are running a Sirius supported client"
                        clientSubtitle.Text = "Anda menjalankan klien yang didukung Sirius."
                    end
                    
                    -- 3. Memodifikasi frame Friends beserta teks Subtitle-nya
                    friendsFrame.Position = UDim2.new(0, 511, 0, 228)
                    friendsFrame.Size = UDim2.new(0, 371, 0, 214)
                    local friendsSubtitle = friendsFrame:FindFirstChild("Subtitle")
                    if friendsSubtitle then
                        -- Teks asli: "Find out what your friends are currently doing"
                        friendsSubtitle.Text = "Cari tahu apa yang sedang dilakukan teman-teman Anda saat ini."
                    end
                    
                    -- 4. Memodifikasi frame Server beserta teks Subtitle-nya
                    serverFrame.Position = UDim2.new(0, 82, 0, 228)
                    serverFrame.Size = UDim2.new(0, 420, 0, 283)
                    local serverSubtitle = serverFrame:FindFirstChild("Subtitle")
                    if serverSubtitle then
                        -- Teks asli: "Information on the session you're currently in"
                        serverSubtitle.Text = "Informasi tentang sesi yang sedang Anda ikuti saat ini."
                    end
                    
                    -- 5. Memodifikasi frame User
                    userFrame.Position = UDim2.new(0, 82, 0, 129)
                    userFrame.Size = UDim2.new(0, 356, 0, 90)
